...
const submit = () => {
  form.post(route('updateImage', props.restaurant.id));
};
...
<template>
  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-100 mt-10">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
      <h1 class="text-2xl font-bold text-center mb-6">Editar Restaurante</h1>
      <form @submit.prevent="submit" enctype="multipart/form-data"
        ...
        <div class="mb-4">
          ...
          <input
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            id="address" v-model="form.address" type="text" required>
        </div>
        <div class="mb-4">
          ...
          <input
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            id="latitude" v-model="form.latitude" type="number" min="-90" max="90" step="0.0000001" required>
        </div>
        <div class="mb-4">
          ...
          <input
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            id="longitude" v-model="form.longitude" type="number" min="-180" max="180" step="0.0000001" required>
        </div>
        <div class="mb-6">
